...
The dashboard is built on processed datasets (`matches_data` and `players_data`) scraped from [HLTV.org](https://www.hltv.org) using the HLTV-scraper repository: [HLTV-Data-Collection-Web-Scraping](https://github.com/M4teusz00/HLTV-Data-Collection-Web-Scraping).
