...
The dashboard is built on processed datasets (`matches_data` and `players_data`) scraped from [HLTV.org](https://www.hltv.org) using the [HLTV-Data-Collection-Web-Scraping](https://github.com/M4teusz00/HLTV-Data-Collection-Web-Scraping) repository.
...
The source data in this Excel file is generated by the **HLTV-scraper** repository [HLTV-Data-Collection-Web-Scraping](https://github.com/M4teusz00/HLTV-Data-Collection-Web-Scraping) 
All match and player stats are scraped directly from [HLTV.org](https://www.hltv.org) using the Python scripts described in the HLTV-Data-Collection-Web-Scraping repository.
